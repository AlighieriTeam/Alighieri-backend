...
#     print("[be useless pls] draw_rectangle called with arguments: {} {} {} {} {}".format(x, y, color, width, height))
#     room = session.get("room")
#     data = {
#         "x": x,
#         "y": y,
...
#     print("[be useless pls] draw_circle called with arguments: {} {} {} {}".format(x, y, color, radius))
#     room = session.get("room")
#     data = {
#         "x": x,
#         "y": y,
...
#     print("[be useless pls] draw_text called with arguments: {} {} {} ".format(x, y, text))
#     room = session.get("room")
#     data = {
#         "x": x,
#         "y": y,
...
# def clear_all():
#     print("[be useless pls] clear_all called")
#     room = session.get("room")
